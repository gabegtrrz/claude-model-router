@echo off
REM Launch Claude Code using Kimi K2.6 via Moonshot AI
...
set ANTHROPIC_DEFAULT_OPUS_MODEL=kimi-k2.6
set ANTHROPIC_DEFAULT_SONNET_MODEL=kimi-k2.6
set ANTHROPIC_DEFAULT_HAIKU_MODEL=kimi-k2.6
set CLAUDE_CODE_SUBAGENT_MODEL=kimi-k2.6
